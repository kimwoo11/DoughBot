...
{
    public class IBWrapperDC : EWrapper
    {
        //! [ewrapperimpl]
        ...
        //! [socket_declare]
        public HistoricalDataCollector hdc;
        //! [socket_init]
        public IBWrapperDC(HistoricalDataCollector historicalDataCollector)
        {
        ...
        public virtual void historicalDataEnd(int reqId, string startDate, string endDate)
        {
            ...
            hdc.DataCollectionCompleted = true;
        }
        //! [historicaldataend]
        ...
        public void historicalTicksLast(int reqId, HistoricalTickLast[] ticks, bool done)
        {
            foreach (var tick in ticks)
            {
                ...
                //    reqId, Util.UnixSecondsToString(tick.Time, "yyyyMMdd HH:mm:ss"), tick.Price, tick.Size, tick.Exchange, tick.SpecialConditions, tick.TickAttribLast.toString());
                hdc.HistoricalTicks.Add(new DoughBot.Tick(tick.Time, tick.Price, ""));
                hdc.CurrentTime = tick.Time;
            }
            if (done)
            {
